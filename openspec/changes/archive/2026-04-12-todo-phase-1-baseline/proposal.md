...
## Scope
- `index.html` with a static list of 3 "seed" tasks.
- `style.css` for layout, centering, and professional typography.

## Success Criteria
- The page opens in a browser and displays "Buy milk", "Learn SDD", and "Practice HTML".
